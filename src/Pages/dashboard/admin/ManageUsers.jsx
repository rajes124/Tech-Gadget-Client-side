...
const ManageUsers = () => {
  ...
  if (loading) return <div className="text-center py-20 text-2xl">Loading users...</div>;

  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-12 px-4">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-4xl sm:text-5xl font-black text-center mb-10 text-transparent bg-gradient-to-r from-red-600 to-orange-600 bg-clip-text">
          Manage Users
        </h1>
