...
const Home = () => {
  ...
  return (
    <div className="w-full font-sans text-gray-700 bg-gradient-to-b from-gray-100 via-gray-50 to-white">
      ...
      {/* Hero Section */}
      <section className="flex flex-col justify-center items-center min-h-[70vh] text-center px-6 md:px-12 bg-gradient-to-b from-blue-50 to-white relative overflow-hidden">
        ...
        >
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold mb-4 tracking-tight text-gray-900">
          ...
          <motion.p
            ...
            className="text-gray-600 mb-8 max-w-xl sm:max-w-2xl text-base sm:text-lg"
          >
      ...
      <section className="h-[50vh] sm:h-[55vh] md:h-[60vh] flex items-center justify-center text-center relative overflow-hidden">
        ...
        <motion.div
          ...
          transition={{ duration: 1.2, ease: "easeOut" }}
          className="bg-black/60 p-6 sm:p-10 rounded-2xl md:rounded-3xl max-w-xl sm:max-w-3xl z-10 backdrop-blur-sm"
        >
            ...
            {products.slice(0, 6).map((p) => {
              ...
              return (
                <motion.div
                  ...
                  className="bg-white rounded-2xl sm:rounded-3xl shadow-lg hover:shadow-2xl overflow-hidden transition-transform duration-300 relative"
                >
                  ...
                  <div className="p-4 sm:p-5 flex flex-col justify-between h-52 sm:h-56">
                    <div>
                      ...
                      <p className="text-gray-800 font-semibold text-sm sm:text-base mb-1">Price: ${p.price}</p>
                      <p className="text-gray-600 text-xs sm:text-sm flex items-center gap-1 mb-2">{flag} {p.originCountry || "Unknown"}</p>
      ...
      <section className="bg-gradient-to-r from-blue-100 to-blue-50 py-16 sm:py-20 px-4 sm:px-6">
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center mb-12">
          Why Choose <span className="text-blue-700">Tech Gadget Import Export Hub?</span>
        </h2>
        <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 md:gap-10">
          {[
            ...
            { icon: <FaHandshake size={40} className="text-blue-600" />, title: "Trusted Partnership", desc: "Build long-term trade relationships with global exporters." },
          ].map((item, idx) => (
            <motion.div key={idx} whileHover={{ y: -5, scale: 1.03 }} className="bg-gradient-to-br from-white to-blue-50 rounded-2xl sm:rounded-3xl p-6 sm:p-8 shadow-lg hover:shadow-2xl text-center transition-all duration-300">
