  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <header className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl border-b border-gray-200 dark:border-gray-700 px-6 py-4 flex items-center justify-between sticky top-0 z-10">
          <button
          ...
          {/* User Info Card – navbar-এর সাথে মিলিয়ে */}
          <div className="flex items-center gap-5 bg-gray-100/70 dark:bg-gray-700/70 backdrop-blur-md rounded-3xl px-6 py-4 shadow-xl border border-gray-200 dark:border-gray-600">
            <img
              src={user.photoURL || "https://i.ibb.co/2kzH8v1/user.png"}
              alt="Profile"
              className="w-16 h-16 rounded-full ring-4 ring-blue-500/40 shadow-2xl object-cover"
            />
            <div>
