...
const DashboardLayout = () => {
  const { theme } = useOutletContext(); // dark mode
  ...
  // Admin menu (extra marks এর জন্য)
  if (isAdmin) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex">
      ...
      <div className="flex-1 flex flex-col">
        {/* Top Bar */}
        <header className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl border-b border-gray-200 dark:border-gray-700 px-6 py-4 flex items-center justify-between">
          <button
        ...
        <main className="flex-1 p-6 lg:p-10 overflow-y-auto bg-gray-50 dark:bg-gray-900">
          <Outlet /> {/* এখানে DashboardHome, MyExports ইত্যাদি দেখাবে */}
        </main>
      </div>
    </div>
  );
