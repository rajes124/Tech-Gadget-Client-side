      ...
      <div className="min-h-screen bg-white py-12 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <motion.div
            ...
            className="grid grid-cols-1 lg:grid-cols-2 gap-12 bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-100"
          >
            {/* Image Gallery */}
            ...
            <div className="p-8 lg:p-12 flex flex-col justify-between">
              ...
              <div className="flex gap-4">
                <Link
                  to="/products"
                  className="flex-1 flex items-center justify-center gap-2 py-4 px-6 bg-gray-100 text-gray-800 font-medium rounded-xl hover:bg-gray-200 transition"
                >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                {relatedProducts.map((rel) => (
                  <Link
                    key={rel._id}
                    to={`/product/${rel._id}`}
                    className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition border border-gray-100"
                  >
                    <img src={rel.image} alt={rel.name} className="w-full h-48 object-cover" />
                    <div className="p-5">
                      <h3 className="font-semibold text-lg text-gray-900 truncate">{rel.name}</h3>
              ...
              <div className="space-y-5">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-5 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                  />
                </div>
                ...
                <div className="pt-4 flex gap-4">
                  <button
                    ...
                    className="flex-1 py-3 px-6 border border-gray-300 rounded-xl font-medium hover:bg-gray-100 transition"
                  >
                    Cancel
                  </button>
                  <button
