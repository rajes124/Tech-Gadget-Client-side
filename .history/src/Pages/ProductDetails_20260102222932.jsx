...
const ProductDetails = () => {
    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center transition-colors">
        <div className="space-y-4 w-full max-w-6xl mx-auto px-6">
          <div className="h-8 bg-gray-300 dark:bg-gray-700 rounded w-1/3 animate-pulse" />
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="h-96 bg-gray-300 dark:bg-gray-700 rounded-2xl animate-pulse" />
            <div className="space-y-4">
              {[1, 2, 3, 4].map(i => (
                <div key={i} className="h-6 bg-gray-300 dark:bg-gray-700 rounded animate-pulse" />
              ))}
            </div>
          </div>
        </div>
  ...
  const images = [product.image, product.image, product.image]; // Add more if available
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-12 px-6 transition-colors duration-300">
        <div className="max-w-7xl mx-auto">
          ...
          <motion.div
            ...
            className="grid grid-cols-1 lg:grid-cols-2 gap-12 bg-white dark:bg-gray-800 rounded-3xl shadow-xl overflow-hidden border border-gray-200 dark:border-gray-700 transition-colors"
          >
            {/* Image Gallery */}
            <div className="relative bg-gray-100 dark:bg-gray-700">
              ...
              <div className="flex gap-2 p-4 justify-center bg-white dark:bg-gray-800">
                {images.map((_, idx) => (
                  <button
                    key={idx}
            ...
            <div className="p-8 lg:p-12 flex flex-col justify-between">
              ...
              <div className="flex gap-4">
                {/* Changed to "Back to Home" and links to "/" */}
                <Link
                  to="/"
                  className="flex-1 flex items-center justify-center gap-2 py-4 px-6 bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-200 font-medium rounded-xl hover:bg-gray-200 dark:hover:bg-gray-600 transition"
                >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                {relatedProducts.map((rel) => (
                  <Link
                    key={rel._id}
                    to={`/product/${rel._id}`}
                    className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition border border-gray-200 dark:border-gray-700"
                  >
              ...
              <div className="space-y-5">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-5 py-3 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                  />
                </div>
                ...
                <div className="pt-4 flex gap-4">
                  <button
                    ...
                    className="flex-1 py-3 px-6 border border-gray-300 dark:border-gray-600 rounded-xl font-medium hover:bg-gray-100 dark:hover:bg-gray-700 transition text-gray-800 dark:text-gray-200"
                  >
                    Cancel
                  </button>
                  <button
