...
const Home = ({ theme }) => {
  ...
  return (
    <div className={`w-full font-sans ${isDark ? "bg-gray-900 text-gray-100" : "text-gray-700 bg-gradient-to-br from-gray-50 to-blue-50/30"} min-h-screen`}>
      ...
      {/* 1. Hero Section - 70vh max */}
      <section className={`flex flex-col justify-center items-center min-h-[70vh] max-h-[70vh] text-center px-6 md:px-12 relative overflow-hidden ${
        ...
        >
          ...
          <motion.p
            ...
            className="text-xl sm:text-2xl md:text-2xl max-w-2xl mb-10 leading-relaxed opacity-90"
          >
