        ...
        {products.slice(0, 8).map((p, idx) => (
          ...
          >
            <div className="relative overflow-hidden h-48 sm:h-52 md:h-56 lg:h-60 bg-gradient-to-br from-blue-50 to-green-50 dark:from-gray-700 dark:to-gray-800">
              ...
              {/* Multiple Compact Badges with SVG Icons (No Emoji) */}
              <div className="absolute top-3 left-3 flex flex-col gap-2">
                {/* Rating Badge - Small & Compact */}
                <div className="bg-gradient-to-r from-yellow-400 to-amber-500 dark:from-yellow-500 dark:to-amber-600 text-black dark:text-white px-2.5 py-1 rounded-full text-xs font-bold flex items-center gap-1 shadow-md backdrop-blur-sm">
                ...
                {/* TOP / HOT Badge - Small & Gradient */}
                <div className={`px-2.5 py-1 rounded-full text-xs font-bold flex items-center gap-1 shadow-md backdrop-blur-sm text-white ${
            ...
            <div className="p-5 sm:p-6 flex flex-col flex-1 justify-between">
              ...
              <div className="space-y-3 mt-auto">
                {/* Stock & Shipping Info - Compact with SVG Icons */}
