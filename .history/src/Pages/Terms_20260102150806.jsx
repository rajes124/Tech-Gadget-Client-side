...
const Terms = () => {
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-black">
      <div className="max-w-4xl mx-auto px-6 py-12 bg-white dark:bg-black rounded-lg shadow-xl mt-10 mb-20 border border-gray-200 dark:border-gray-800">
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none text-gray-800 dark:text-gray-200 space-y-10">
          <section>
