...
// Lucide Icons import করা হয়েছে
import { DollarSign, Globe, Package, Star, ArrowLeft, Truck } from "lucide-react";
...
const ProductDetails = () => {
      ...
      <div className="max-w-6xl mx-auto py-12 px-4 sm:px-6 lg:px-8 flex-1">
        ...
        >
          ...
          <div className="space-y-4">
            ...
            <div className="text-gray-800 text-sm sm:text-base space-y-3">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-6">
              <Link to="/" className="flex items-center justify-center gap-2 px-6 py-2 rounded-xl bg-gray-200 text-gray-800 font-medium shadow hover:shadow-md hover:bg-gray-300 transition">
              ...
              <motion.button
                ...
                className="flex items-center justify-center gap-2 bg-gradient-to-r from-blue-600 to-indigo-700 text-white font-semibold px-8 py-2.5 rounded-xl shadow-lg hover:shadow-blue-300 transition"
              >
      ...
      <AnimatePresence>
        {showModal && (
          ...
          >
            ...
            >
              <h3 className="text-2xl font-bold text-gray-900 drop-shadow-sm flex items-center gap-2">
                <Truck className="w-7 h-7" />
                Import Product
              </h3>
              <p className="text-gray-700 text-sm flex items-center gap-2">
                <Package className="w-5 h-5" />
                Available Quantity: <span className="font-semibold">{product.availableQuantity}</span>
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-3 mt-2">
                ...
                <button
                  ...
                  className={`w-full sm:w-auto px-5 py-3 rounded-xl font-semibold transition text-white flex items-center justify-center gap-2 ${importQuantity <= 0 || importQuantity > product.availableQuantity || submitting ? "bg-gray-400 cursor-not-allowed" : "bg-gradient-to-r from-indigo-600 to-blue-600 hover:from-indigo-700 hover:to-blue-700 shadow-md"}`}
                >
  ...
  function handleImport() {
    ...
    if (importQuantity <= 0 || importQuantity > product.availableQuantity) { toast.warn("Enter valid quantity!"); return; }
