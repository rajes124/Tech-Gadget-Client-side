...
const Terms = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 dark:from-black dark:via-gray-900 dark:to-black">
      <div className="max-w-4xl mx-auto px-6 py-12 bg-white/80 dark:bg-gray-900/90 backdrop-blur-sm rounded-lg shadow-xl mt-10 mb-20">
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none text-gray-800 dark:text-gray-200 space-y-8">
          <section>
