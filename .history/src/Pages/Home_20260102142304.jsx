...
<section className="py-20 sm:py-24 px-6 md:px-12 bg-gradient-to-b from-blue-50 to-white dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 max-w-5xl mx-auto">
      {[
        ...
        <motion.div
          ...
          className="group bg-white dark:bg-gray-800/70 rounded-3xl p-10 shadow-xl hover:shadow-2xl border border-gray-100 dark:border-gray-700 transition-all duration-500 hover:-translate-y-4"
        >
          ...
          <div className="text-4xl md:text-5xl font-black text-gray-900 dark:text-white mb-3 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">
            {stat.value}
          </div>
