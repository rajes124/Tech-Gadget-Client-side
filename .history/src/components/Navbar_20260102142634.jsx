...
const Navbar = ({ theme, setTheme }) => {
  ...
  return (
    <nav className="backdrop-blur-xl bg-white/80 dark:bg-gray-900/90 shadow-lg sticky top-0 z-50 border-b border-gray-200/50 dark:border-gray-800 transition-all duration-300">
