  ...
  return (
    <footer className={`py-12 mt-20 border-t ${isDark ? "bg-gray-900/95 border-gray-800 text-gray-300" : "bg-white/95 border-gray-200 text-gray-700"} backdrop-blur-md`}>
      <div className="max-w-7xl mx-auto px-6">
        {/* Grid - Mobile-এ stacked, Desktop-এ 4 columns */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12">
          ...
          {/* Contact - তোমার real info দিয়ে update করলাম */}
          <div className="text-center sm:text-left">
            <h3 className={`text-lg font-bold mb-5 ${isDark ? "text-white" : "text-gray-900"}`}>Contact Us</h3>
            <ul className="space-y-4 text-sm">
              <li className="flex items-center gap-3 justify-center sm:justify-start">
                <FaEnvelope className="text-green-500" />
                <a href="mailto:rajesray307@gmail.com" className="hover:text-green-500 dark:hover:text-green-400">
                  rajesray307@gmail.com
                </a>
              </li>
              <li className="flex items-center gap-3 justify-center sm:justify-start">
                <FaPhone className="text-green-500" />
                <a href="tel:01407539879" className="hover:text-green-500 dark:hover:text-green-400">
                  01407539879
                </a>
              </li>
              <li className="flex items-center gap-3 justify-center sm:justify-start">
                <FaMapMarkerAlt className="text-green-500" />
                <span className="hover:text-green-500 dark:hover:text-green-400 cursor-pointer">
                  Mymensingh, Netrakona, Mymensingh, Bangladesh
                </span>
              </li>
            </ul>
          </div>
          ...
          <div className="text-center sm:text-left">
            ...
            <form className="flex flex-col sm:flex-row gap-3 max-w-sm mx-auto sm:mx-0">
              <input
                type="email"
              ...
              <button 
                type="submit"
                className="bg-green-500 hover:bg-green-600 text-white px-6 py-3 rounded-lg font-medium transition whitespace-nowrap"
              >
                Subscribe
              </button>
            </form>
